...
import com.jswarburton.adventofcode.day03.CrossedWires.manhattanDistanceToNearestIntersection
...
class CrossedWiresTest extends AnyFlatSpec with Matchers {
  ...
  private val filePath = "src/main/resources/day03/puzzle1and2-input.txt"

  it should "produce the correct outputs 1" in {
  ...
  it should "produce the correct outputs 2" in {
  ...
  it should "produce the correct outputs 3" in {
